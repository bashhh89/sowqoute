...
id of the invite in the database.
...
slug of the workspace in the database
...
Target folder path (defaults to 'custom-documents' if not provided)
...
Name of the folder to retrieve documents from
...
Unique document name to find (name in /documents)
...
Unique slug of workspace to find
...
Unique slug of workspace to delete
...
Unique slug of workspace to search in
...
The ID of the user to issue a temporary auth token for
