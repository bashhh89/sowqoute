...
the thing is what i really care about the mosy is the output i want it generate the exact the same way ,
in terms of how everything is structueredand flow and animation and all of that the only thing i want to get  rid of the complexity bs and to be able to use pollination thats all , so why dont u analyze this shit firt and report back what its is what  s it how it works and what are good prompts  to s use to create my own 
